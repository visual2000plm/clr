...
{
    public static class PdmCacheManager
    {
        ...
        public static readonly Dictionary<string, PdmBlockSubItemClrDto> DictInternalCodeBlockSubItemCache = new Dictionary<string, PdmBlockSubItemClrDto>();
        ...
        public static readonly Dictionary<int, PdmEntityBlClrDto> DictPdmEntityBlEntity = new Dictionary<int, PdmEntityBlClrDto>();
      ...
      //  public static readonly Dictionary<int, PdmReferenceViewColumnClrDto> DictPdmReferenceViewColumnCache = new Dictionary<int, PdmReferenceViewColumnClrDto>();
        ...
        private static readonly Dictionary<string, List<GridColumnClrUserDefineDto>> DictMainTabBlokGridColumnExternaMappingCache = new Dictionary<string, List<GridColumnClrUserDefineDto>>();
       ...
       // public PdmBlockSubItemClrDto GetBlockSubItemWithInternalcode ()
            ...
            if (!string.IsNullOrEmpty(entity.ConnectInfo))
            {
                try
                {
                    using (SqlConnection conn = new SqlConnection(entity.ConnectInfo))
                    {
                        ...
                        CLROutput.OutputDebug( "entity.LastScanCheckSum: " + entity.LastScanCheckSum + "lastChange :" + lastChange,conn);
        ...
        private static List<GridColumnClrUserDefineDto> GetTabGridBlockColumnAliasName(int tabId, PdmBlockClrDto dmBlockClrDto, bool IsGetAliasname)
        {
          ...
          //   GridColumnClrUserDefineDto include full qulifyied name
            ...
            string overrideFieldName = "AliasName";
            if(!IsGetAliasname)
            {
                overrideFieldName = "ExternalMappingName";
                 
            }

            string queryPdmTabGridMetaColumn = string.Format (@" SELECT  distinct   dbo.pdmTabGridMetaColumn.GridColumnID,
                        dbo.pdmTabGridMetaColumn.Visible, dbo.pdmTabGridMetaColumn.{0} as AliasName,
                        ...
                        AND (dbo.pdmTabGridMetaColumn.BlockID = @GridBlockID)", overrideFieldName);
            ...
            // alias Name will oervride the full qulified name ???
        ...
        public static PdmBlockSubItemClrDto GetPdmBlockSubItemDtoWithInternalCode(string internalCode)
        {
            return DictInternalCodeBlockSubItemCache[internalCode];
...
ORDER BY dbo.pdmBlockSubItem.SubItemID", anytabID);
        ...
        private static List<BlockSubitemClrUserDefineDto> RetriveBlockSubitemFullPathNameAndControlType(SqlConnection conn, string qeuryTabBlockSubitem)
        {
            ...
            foreach (DataRow aRow in resultTabel.Rows)
            {
                ...
                {
                    PdmEntityBlClrDto aEntityBlClrDto = DictPdmEntityBlEntity[entityID.Value];
      ...
      //  MainTabBlockSubitem
        ...
        private static void SetupGridAndGridColumn(SqlConnection conn)
        {
            ...
            foreach (PdmGridMetaColumnClrDto aPdmGridMetaColumnClrDto in columnList)
            {
                ...
                {
                    PdmEntityBlClrDto aEntityBlClrDto = DictPdmEntityBlEntity[aPdmGridMetaColumnClrDto.EntityId.Value];
        ...
        private static void SetupEntityAndEntityColumn(SqlConnection conn)
        {
            ...
            foreach (PdmEntityBlClrDto aPdmEntityBlClrDto in entityList)
            {
                ...
                DictPdmEntityBlEntity.Add(aPdmEntityBlClrDto.EntityId, aPdmEntityBlClrDto);
